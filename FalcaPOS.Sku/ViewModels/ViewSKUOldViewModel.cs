...
{
    public class ViewSKUOldViewModel : BindableBase
    {
        ...
        public ViewSKUOldViewModel(IStoreService storeService, ProgressService progressService, IInvoiceFileService invoiceFileService, INotificationService notificationService, ISkuService skuService, Logger logger, IProductTypeService productTypeService)
        {
