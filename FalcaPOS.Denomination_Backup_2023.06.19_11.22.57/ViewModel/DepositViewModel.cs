    ...
    public class DepositViewModel : BindableBase
    {
        ...
        public async void SearchData(object obj)
        {
            try
            {
                ...
                {
                    _notificationService.ShowMessage("Please Enter FromDate", Common.NotificationType.Error);
                    return;
                }
                if (string.IsNullOrEmpty(ToDate))
                {
                    _notificationService.ShowMessage("Please Enter ToDate", Common.NotificationType.Error);
                    return;
                }
