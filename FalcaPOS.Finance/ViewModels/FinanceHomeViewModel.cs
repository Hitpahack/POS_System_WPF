...
namespace FalcaPOS.Finance.ViewModels
{
    public class FinanceHomeViewModel : BindableBase
    {
        ...
        public FinanceHomeViewModel(IFinanceService financeService, Logger logger, IEventAggregator eventAggregator, IStoreService storeService, INotificationService notificationService, ICommonService commonService, ProgressService progressService, ISalesService salesService)
        {
            ...
            IsDirectorlogin = (AppConstants.USER_ROLES[0] == AppConstants.ROLE_DIRECTOR) ? true : false;
        ...
        private bool _isDirectorlogin;

        public bool IsDirectorlogin
        {
            get => _isDirectorlogin;
            set => SetProperty(ref _isDirectorlogin, value);
        }
                        ...
                        Application.Current.Dispatcher.Invoke(() =>
                        {
                            ...
                            try
                            {
                                ...
                                if(salesObj.Printer != null)
                                {
                                    ...
                                    {
                                        _p.UseShellExecute = true;
                                        _p.FileName = salesObj.Printer.ToLower() == "a4" ? result.data.sign_tiny_response._A4 : result.data.sign_tiny_response._4inch;
                                    }                                  
