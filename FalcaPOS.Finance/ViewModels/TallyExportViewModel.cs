        ...
        private void ExportResultToExcel()
        {
            try
            {
                ...
                if (Type == "Sales")
                {
                    ...
                    bool _result = _commonService.ExportToXL(TallyExportSales, _fileName, skipfileName: false, tablename: "Falca POS Tally Report", FilePath: ApplicationSettings.TALLYREPORTS_PATH.ToString());
