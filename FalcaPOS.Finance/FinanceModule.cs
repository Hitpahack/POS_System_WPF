...
namespace FalcaPOS.Finance
{
    public class FinanceModule : IModule
    {
        public void OnInitialized(IContainerProvider containerProvider)
        {
            ...
            if (AppConstants.USER_ROLES != null && ( AppConstants.USER_ROLES.Contains(AppConstants.ROLE_FINANCE)|| AppConstants.USER_ROLES.Contains(AppConstants.ROLE_CONTROL_MANAGER)))
            {
