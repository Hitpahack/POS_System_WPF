...
namespace FalcaPOS.Sku.ViewModels
{
    public class BrandCardViewModel : ValidationBase
    {
        ...
        public BrandCardViewModel(IEventAggregator EventAggregator, IUnityContainer container, CategoryModel category, IProductService productService, IProductTypeService productTypeService, ISupplierService supplierService, INotificationService notificationService, Logger logger, ISkuService skuService, ProgressService ProgressService,SubCategoryModel SubCategory)
        {
        ...
        private async void SearchExistingSKUCertificate()
        {
            try
            {
                ...
                {
                    _notificationService.ShowMessage("Please select Department", NotificationType.Error);
                    return;
                }
                ...
                var _productcertificate = await _skuService.GetproductCertificate(new Entites.Sku.ProductCertificateSearch() { departmentId = (int)SelectedSubCategory.Id, manufactureID = SelectedManufacturer.ManufacturerId, storeId = AppConstants.LoggedInStoreInfo.StoreId });
        ...
        private void headerChange(CategoryModel category)
        {
            ...
            var _certificateCategory = GetCertificateCategory();
