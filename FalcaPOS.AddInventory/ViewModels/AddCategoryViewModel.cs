    ...
    public class AddCategoryViewModel : BindableBase
    {
        ...
        private async void AddCategory()
        {
            ...
            if (!Certificate.IsValidString()) {
                _notificationService.ShowMessage("Please select certificate category is requires or not", NotificationType.Error);
                return;
            }
            if (Certificate == "Yes") {
                ...
                await Task.Run(async () =>
                {
                    ...
                    if (_result != null &&_result.IsSuccess)
                    {
                        Application.Current?.Dispatcher?.Invoke(() =>
                        {
                            ...
                            // close the addcategory popup after adding the category successfully.
                            PopupClose = false;
                        });
        ...
        public bool PopupClose
        {
            ...
            set
            {
                if (_popupClose != false && CategoryName != null || Certificate != null)
                {
                    ResetData();
                }
