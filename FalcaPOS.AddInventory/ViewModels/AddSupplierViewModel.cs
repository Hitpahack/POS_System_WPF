...
namespace FalcaPOS.AddInventory.ViewModels
{
    public class AddSupplierViewModel : ValidationBase
    {
        ...
        private bool ValidateData()
        {
            ...
            else if (!GstNumber.IsValidGST())
            {
                ShowAlert("GST number is invalid", NotificationType.Error);
        ...
        [Required(ErrorMessage = "TallyCode is required")]
        public string TallyCode
        {
            get { return _tallyCode; }
            set {
                SetProperty(ref _tallyCode, value);
                if (value != null) ValidateProperty(value);
            } 
        }
        ...
        {
            get => _appendName;
            set => SetProperty(ref _appendName,value);
        }
