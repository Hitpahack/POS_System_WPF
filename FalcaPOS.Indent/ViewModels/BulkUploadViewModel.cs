            ...
            try
            {
                ...
                if (xlWorksheet.Name.ToLower() == "falca pos sbi bulk payment")
                {
                    ...
                    for (int i = 2; i <= rowCount; i++)
                    {
                        ...
                        var GrossTotal = xlRange.Cells[i, 6].Value2;
                        var TDS = xlRange.Cells[i, 7].Value2;
                        var Amount = xlRange.Cells[i, 8].Value2;
                        var Phone = xlRange.Cells[i, 14].Value2.ToString();
                        var StoreName = xlRange.Cells[i, 13].Value2.ToString();

                        var PaymentRefNo = xlRange.Cells[i, 15].Value2.ToString();
                        var UTR = xlRange.Cells[i, 16].Value2.ToString();
                        var PaymentDate = xlRange.Cells[i, 17].Value2.ToString();
                        double date = double.Parse(PaymentDate);

                        var dateTime = DateTime.FromOADate(date).ToString("dd-MM-yyyy");
                        var BeneficiaryName = xlRange.Cells[i, 9].Value2.ToString();
                        var BeneficiaryBranchCode = xlRange.Cells[i, 10].Value2.ToString();
                        var CreditAccountNo = xlRange.Cells[i, 11].Value2.ToString();
                        var EmailId = xlRange.Cells[i, 12].Value2.ToString();
                        string InvoiceNo = null;
                        if (xlRange.Cells[i, 18].Value2 != null)
                        {
                            InvoiceNo = xlRange.Cells[i, 18].Value2.ToString();
                ...
                else if (xlWorksheet.Name.ToLower() == "falca pos icici bulk payment")
                {
                    ...
                    for (int i = 2; i <= rowCount; i++)
                    {
                        ...
                        var GrossTotal = xlRange.Cells[i, 5].Value2;
                        var TDS = xlRange.Cells[i, 6].Value2;
                        var Amount = xlRange.Cells[i, 7].Value2;
                        var PaymentMode = xlRange.Cells[i, 8].Value2;
                        var Date = xlRange.Cells[i, 9].Value2.ToString();
                        var IFSC = xlRange.Cells[i, 10].Value2.ToString();

                        var BeneficiaryMobile = xlRange.Cells[i, 13].Value2.ToString();


                        var EmailId = xlRange.Cells[i, 14].Value2.ToString();

                        var PoNo = xlRange.Cells[i, 24].Value2.ToString();

                        var UTR = xlRange.Cells[i, 25].Value2.ToString();
                        ...
                        {
                            InvoiceNo = xlRange.Cells[i, 26].Value2.ToString();
