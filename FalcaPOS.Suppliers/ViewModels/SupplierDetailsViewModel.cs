...
namespace FalcaPOS.Suppliers.ViewModels
{
    public class SupplierDetailsViewModel : BindableBase
    {
        ...
        private bool ValidateData()
        {
            ...
            else if (ISMSME == "Yes" && !string.IsNullOrEmpty(SuppliersDetails.MSME) && (SuppliersDetails.MSMECertificate.FileName == null && FileUploadMSME == null))
            {
        ...
        /// <summary>
        /// Fetches the Supplier Bank Details after adding a bank. 
        /// </summary>
        /// <param name="supplier">supplier details data from the UI.</param>
        public async void GetSupplierBankDetails(SuppliersDetailsViewModel supplier)
        {
            try
            {
        ...
        public async void AddNewBankDetail(object ob)
        {
            try
            {
                ...
                if (_result != null && _result.IsSuccess)
                {
                    ...
                    GetSupplierBankDetails(suppliers);
                    return;
                }
                else
                {
