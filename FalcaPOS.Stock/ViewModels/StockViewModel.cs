...
namespace FalcaPOS.Stock.ViewModels
{
    public class StockViewModel : BindableBase
    {
        ...
        public DelegateCommand<object> StockSearchCommand { get; set; }
            ...
            )
        {
            ...
            StockSearchCommand = new DelegateCommand<object>(GetStockSearch);
        ...
        public void GetStockSearch(object obj)
        {
            if (obj != null)
            {
        ...
        public async void LoadData()
        {
            try
            {
                ...
                {
                    Category = SelectedSearchProduct != null ? (SelectedSearchProduct.Category.Id) : SelectedCategoryName?.Id,
                    IsParent = true,
                    Brand = SelectedSearchProduct != null ? (SelectedSearchProduct.Manufacturer.ManufacturerId) : selectedManufacturer?.ManufacturerId,
                    ProductName = SelectedSearchProduct != null ? (SelectedSearchProduct.ProductId) : selectedProduct?.ProductId,
                    ProductType = SelectedSearchProduct != null ? (SelectedSearchProduct.ProductType.ProductTypeId) : SelectedSubCateory?.Id,
                    Status = "Stock",
        ...
        private async void SearchSelectionChanged()
       {
            ...
            try
            {
                ...
                await Task.Run(async () =>
                {
                    ...
                    if (_result != null && _result.IsSuccess && _result.Data != null)
                    {
                        var _productStockCount = await productService.GetStockbySKU(_result.Data.ProductSKU,null);
