    ...
    public partial class App : PrismApplication
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            if (ApplicationSettings.APP_ENVIRONMENT == AppConstants.ENV_PRODUCTION ||
                ApplicationSettings.APP_ENVIRONMENT == AppConstants.ENV_PREPRODUCTION)
            {
            ...
            AutoUpdater.AppTitle = "Falca Suggi Update";
        ...
        protected override void ConfigureViewModelLocator()
        {
            ...
            ViewModelLocationProvider.Register<Denomination.View.EODCashDeclarationFinanceView, Denomination.ViewModel.EODCashDeclarationFinanceViewModel>();
            ...
            ViewModelLocationProvider.Register< DenominationHome, DenominationHomeViewModel>();
            ...
            ViewModelLocationProvider.Register<Stock.Views.StockTransferHome, Stock.ViewModels.StockTransferHomeViewModel>();
            ...
            ViewModelLocationProvider.Register<DenominationDepositDetailsView, DenominationDepositDetailsViewModel>();
            ...
            ViewModelLocationProvider.Register<Sku.View.AddNewProductCertificate, Sku.ViewModels.AddNewProductCertificateViewModel>();
            ...
            ViewModelLocationProvider.Register<AddDenominationCountView, AddDenominationCountViewModel>();
            ...
            ViewModelLocationProvider.Register<Reports.View.Report, Reports.ViewModel.ReportViewModel>();
            ViewModelLocationProvider.Register<Stock.Views.StockTransfer, Stock.ViewModels.StockTransferViewModel>();
            ViewModelLocationProvider.Register<Stock.Views.StockTransferHomeV2, Stock.ViewModels.StockTransferHomeV2ViewModel>();
            ViewModelLocationProvider.Register<Sku.View.ApproveSKUFinance,Sku.ViewModels.ApproveSKUFinanceViewModel>(); 

            //ViewModelLocationProvider.Register<Store.Views.EditStoreLicense, Store.ViewModels.EditStoreLicenseViewModel>();
        ...
        protected override void ConfigureModuleCatalog(IModuleCatalog moduleCatalog)
        {
            ...
            _ = moduleCatalog.AddModule<ZoneServiceModule>();
            _ = moduleCatalog.AddModule<ReportsServicesModule>();
            _ = moduleCatalog.AddModule<Home.HomeModule>("HomeModule", InitializationMode.OnDemand);
            _ = moduleCatalog.AddModule<SalesModule>("SalesModule", InitializationMode.OnDemand);
            _ = moduleCatalog.AddModule<Customer.CustomerModule>("CustomerModule", InitializationMode.OnDemand);
            _ = moduleCatalog.AddModule<StockModule>("StockModule", InitializationMode.OnDemand);
            ...
            _ = moduleCatalog.AddModule<ZoneTerritoryModule>(nameof(ZoneTerritoryModule), InitializationMode.OnDemand);
            _ = moduleCatalog.AddModule<ReportsModule>(nameof(ReportsModule), InitializationMode.OnDemand);
